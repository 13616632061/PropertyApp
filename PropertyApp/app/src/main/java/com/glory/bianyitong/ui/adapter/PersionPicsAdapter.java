 ...
 * 动态图片
 */
public class PersionPicsAdapter extends BaseAdapter {
    private Context context;
    private List<ResponseQuerySendInfo.ListNeighborhoodBean.ListNeighborhoodPicBean>  list;

    private LayoutInflater mInflater = null;

    public PersionPicsAdapter(Context context, List<ResponseQuerySendInfo.ListNeighborhoodBean.ListNeighborhoodPicBean>  list) {
