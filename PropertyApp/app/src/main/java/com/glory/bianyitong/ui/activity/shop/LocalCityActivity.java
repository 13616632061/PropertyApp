    ...
    private View.OnKeyListener onKeyListener = new View.OnKeyListener() {
        ...
        public boolean onKey(View v, int keyCode, KeyEvent event) {
            if (keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_DOWN) {
                ...
                if (tag_name.equals("")) {
                    ToastUtils.showToast(LocalCityActivity.this, getResources().getString(R.string.search_can_not_be_empty));//搜索不能为空
                } else {
    ...
    private void request_community2(String name) {
        ...
        OkGoRequest.getRequest().setOnOkGoUtilListener(new OkGoRequest.OnOkGoUtilListener() {
            ...
            public void onSuccess(String s) {
                ...
                if(TextUtil.isEmpty(s)){
                    ...
                    if(responseListCommunity.getStatusCode()==1){
                        ...
                        ScrollViewLayout(LocalCityActivity.this, nearlist, city_community_list);
                    }else {
            ...
            public void onBefore() {
                progressDialog = ProgressDialog.show(LocalCityActivity.this, "", getResources().getString(R.string.load), true);//加载
...
//            Toast.makeText(this, GPS模块正常 ,Toast.LENGTH_SHORT).show();
    ...
    private void startlocation() {
        if (Build.VERSION.SDK_INT >= 23) {
            int checkPermission = ContextCompat.checkSelfPermission(LocalCityActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION);
