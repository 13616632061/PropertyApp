...
public class DynamicDetailsActivity extends BaseActivity implements View.OnLongClickListener {
    ...
    @BindView(R.id.lay_dynamic_commment)
    RelativeLayout layDynamicCommment;
...
//        neighborhoodid = getIntent().getIntExtra("neighborhoodID", 0); //近邻 id
    ...
    private void initdynamic() {
        ...
        dynamic_tv_content.setOnTouchListener(new View.OnTouchListener() {
            @Override
    ...
    public int getScrollY() {
        View c = listView_dynamic.getChildAt(0);
        if (c == null) {
            return 0;
        }
        int firstVisiblePosition = listView_dynamic.getFirstVisiblePosition();
        int top = c.getTop();
